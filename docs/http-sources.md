...
`HttpSource` performs GET requests and has no cursor. Use an ordinary op with
your own client for POST bodies or other protocols; use a [sensor](sensors.md)
or [op state](state.md) for incremental polling. See [connecting](connecting.md).
