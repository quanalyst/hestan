...
walk, the [provenance channel's](assets.md#hue) three rules against a
fixture (one meaning at a time, off draws nothing, and every mark has its name
beside it), the split swatch in the markup it renders, and what each role may see.
