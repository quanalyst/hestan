...
declared no build reads `"build": null` beside `"version": "0.1.0-beta.3"`, and
...
ok    hestan     0.1.0-beta.3 in this deployment's binary, linux/aarch64, features: bundled cli postgres
```
